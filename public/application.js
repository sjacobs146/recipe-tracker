...
/***/ (function(module, exports, __webpack_require__) {
	...
	var navEvents = __webpack_require__(13);
	var recipeEvents = __webpack_require__(14);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://sjacobs146-recipe-api.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onShowCollapsed = function onShowCollapsed() {
	...
	var onNavClick = function onNavClick() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var showRecipesTemplate = __webpack_require__(17);

	var onAddRecipe = function onAddRecipe(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  var recipe = { recipe: data };
	  api.addRecipe(recipe).then(ui.addRecipeSuccess).catch(ui.addRecipeFailure);
	};

	var onFindRecipe = function onFindRecipe(event) {
	  event.preventDefault();
	  var searchString = getFormFields(this).name.toUpperCase();
	  $('.displayRecipe').empty();
	  // TODO: use cache instead of calling api every time
	  api.getRecipesForUser().then(ui.getRecipesForUserSuccess).then(function () {
	    if (store.recipes != null) {
	      var matchingRecipes = [];
	      if (searchString === '') {
	        matchingRecipes = store.recipes;
	      } else {
	        matchingRecipes = store.recipes.filter(function (recipe) {
	          return recipe.name.toUpperCase().includes(searchString);
	        });
	      ...
	      var showRecipesHtml = showRecipesTemplate({ recipes: matchingRecipes });
	...
	var onDelete = function onDelete() {
	  api.deleteRecipe($(this).parent().parent().data('id')).then(ui.deleteRecipeSuccess).then($(this).parent().parent().empty()).catch(ui.deleteRecipeFailure);
	};
	...
	var onEditRecipe = function onEditRecipe(event) {
	  ...
	  delete data.id;
	  var recipe = { recipe: data };
	  api.updateRecipe(recipeId, recipe).then(ui.updateRecipeSuccess).catch(ui.updateRecipeFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getRecipesForUser = function getRecipesForUser() {
	  return $.ajax({
	    url: config.apiOrigin + '/recipes',
	    method: 'GET',
	    headers: {
	...
	var updateRecipe = function updateRecipe(recipeId, data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addRecipeFailure = function addRecipeFailure(error) {
	  $('#message').text('Error adding recipe, please try again.');
	};

	var getRecipesForUserSuccess = function getRecipesForUserSuccess(data) {
	...
	var getRecipesForUserFailure = function getRecipesForUserFailure(error) {
	...
	var deleteRecipeFailure = function deleteRecipeFailure(error) {
	...
	module.exports = {
	  ...
	  getRecipesForUserSuccess: getRecipesForUserSuccess,
	  getRecipesForUserFailure: getRecipesForUserFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <ul class=\"list-unstyled\" data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</li>\n    <li>Serves: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.serves : stack1), depth0))
	    + "</li>\n    <li>Category: "
	    ...
	    + "</li>\n    <li>Directions: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.directions : stack1), depth0))
	    + "</li>\n    <li><button class=\"btn btn-danger deleteRecipeButton\">Delete Recipe</button></li>\n  </ul>\n\n";
